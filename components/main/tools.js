    ...
    return (
        <section className="bg-transparent h-screen pt-48 xsm:pt-12">
            <div className="text-left word-wrap">
                <h1 className="text-6xl xsm:text-3xl font-extrabold tracking-tight leading-none text-white text-center mb-2">Tools</h1>
                <div className="grid justify-center grid-cols-4 gap-4">
                      <Lottie className="h-70 w-70" animationData={htmlLottie} loop={true} />
                      ...
                      <Lottie className="h-70 w-70" animationData={dockerLottie} loop={true} />
                      <Lottie className="h-70 w-70" animationData={githubLottie} loop={true} />
                      <img
